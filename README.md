...
- [Artsy](https://www.artsy.net/jobs) | New York, NY / London, UK / Berlin, Germany / Los Angeles, CA / Hong Kong, Hong Kong / Remote | Our process: First, an informational chat, followed by a phone screen then a call with the hiring manager. Then, interviews with the team focusing on reviewing your work habits and expertise as demonstrated in your previous experience. For technical interviews, we will ask a system design question, as well as your choice of a) bringing code sample from past work, b) a work-related time-boxed take-home exercise, or c) a work-related pair programming exercise with an Artsy engineer. Finally, ~3 in-depth professional reference calls (30-45 mins each).
